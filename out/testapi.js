...
// in main.ts
var api = new api_1.API('http://aimind-backend-dev.iflyresearch.com');
...
api.withInterceptors(function (response) {
...
api.get数据集API().getAllDataSetsAsync({ name: "", $queryParameters: { "test": 1 } }).then(function (resp) {
    console.log(resp);
});
